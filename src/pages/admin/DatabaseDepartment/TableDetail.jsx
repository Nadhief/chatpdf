...
const TableDetail = ({ id }) => {
  ...
  const handleSubmit = (type) => {
    if (type === "column") {
      ...
      addColumnDepartment(payload).then((res) => {
        setOpenDialogAddColumn(false);
        setNewColumns([]);
        fetchKolomDepartment();
      });
    } else if (type === "data") {
      if (editData === true) {
        const payload = {
        ...
        updateDataDepartment(payload).then((res) => {
        ...
        console.log(payload);
        addDataDepartment(payload).then((res) => {
          setOpenDialogAddData(false);
          setNewData({});
          fetchKolomDepartment();
        });
  ...
  const handleDelete = () => {
    ...
    deleteDataDepartment(payload).then((res) => {
      console.log(res);
      fetchKolomDepartment();
    });
  };
